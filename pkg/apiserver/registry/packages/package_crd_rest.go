...
func (r *PackageCRDREST) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*metav1.Table, error) {
	...
	fn := func(obj runtime.Object) error {
		...
		table.Rows = append(table.Rows, metav1.TableRow{
			Cells:  []interface{}{pkg.Name, pkg.Spec.DisplayName, pkg.Spec.ShortDescription, pkg.Spec.Categories, time.Since(pkg.ObjectMeta.CreationTimestamp.Time).Round(1 * time.Second).String()},
	...
	if opt, ok := tableOptions.(*metav1.TableOptions); !ok || !opt.NoHeaders {
		table.ColumnDefinitions = []metav1.TableColumnDefinition{
			...
			{Name: "Categories", Type: "array", Description: "Package categories"},
